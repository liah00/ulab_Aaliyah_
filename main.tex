...
\usepackage{physics}
\usepackage{hyperref}
\usepackage{parskip}% Required for inserting images

\title{Doctor, is this normal?\\ \large ULAB, Division of Sincerely Serious Science}
\author{Aaliyah-Tiffany Anderson }
\date{\today}
...
sidewalk. The image, which can be seen in \autoref{fig:img}, claims that the sidewalk crack resembles the form
